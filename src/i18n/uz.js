export default {
  ...
  menu: {
    title: 'Navigatsiya',
    home: 'Bosh sahifa',
    homeDesc: 'Bosh sahifaga qaytish',
    sign: 'Ulanish',
    signDesc: 'Kalitni qushish',
    clear: 'Tozalash',
    clearDesc: 'Qurilmadagi izlarni olib tashlash',
    code: 'Github',
    codeDesc: 'Repozitoriya',
    help: 'Savollar',
    helpDesc: 'Tizim haqida',
    transaction: 'Tranzaktsiyalar',
    transactionDesc: "Tranzaktsiyalarni ko'rish",
    contacts: 'Kontaktlar',
  ...
  sign: {
    ...
    pwd0: 'Juda oddiy parol',
    pwd1: 'Oddiy parol',
    pwd2: "O'rtacha parol",
    pwd3: 'Ishonchli parol',
  ...
  enter: {
    ...
    hint: 'Mnemonik ibora uchun parol'
  },
  failed: 'Muvaffaqiyatsizlik',
  success: 'Muvaffaqiyat',
  password: 'Parol',
  cancel: 'Bekor qilish',
  ok: 'Ok',
  characters: 'Raqamlar, harflar, belgilar',
  next: 'Davom eting',
  get: 'Oling',
  send: 'Yuborish',
  slider: {
  ...
  aboutPlatform: {
    ...
    opennessText: {
      p1: "Bu ochiq, o'zgarmas, isbotlanadigan kitob.",
      p2: "Sizning ichingizdagi mablag'larning harakatlarini shaffof ravishda kuzatishga imkon beradigan tizim."
    },
    freeText: 'Tranzaksiya tarixiga bepul kirish.',
    securityText: {
