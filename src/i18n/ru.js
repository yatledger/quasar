export default {
  ...
  confirmMessages: {
    clearDevice: {
      clearQuestion: 'Удалить доступ к кошельку с этого устройства?',
      info: 'Не волнуйтесь! Вы всегда сможете восстановить доступ в свой кошелек на этом или другом устройстве, используя мнемоническую фразу или "ceed" ключ.'
    }
  }
}
